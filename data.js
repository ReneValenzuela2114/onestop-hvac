...
const Clientes = {
  ...
  create(datos) {
    ...
    const item = {
      ...
      fact_igual: datos.fact_igual !== false, // true = facturación en la misma dirección
      direccion_fact: datos.direccion_fact?.trim() || "",
      direccion_fact_2: datos.direccion_fact_2?.trim() || "",
  ...
  update(id, datos) {
    ...
    todos[idx] = {
      ...
      fact_igual: datos.fact_igual !== undefined ? datos.fact_igual : (todos[idx].fact_igual !== false),
      direccion_fact: datos.direccion_fact?.trim() ?? todos[idx].direccion_fact ?? "",
      direccion_fact_2: datos.direccion_fact_2?.trim() ?? todos[idx].direccion_fact_2 ?? "",
